...
import static com.github.nagaseyasuhito.fatsia.Criterias.*;
...
import com.github.nagaseyasuhito.fatsia.entity.criteria.GroupCriteria;
import com.github.nagaseyasuhito.fatsia.entity.criteria.UserCriteria;
...
public class CriteriasTest {
    ...
    public void criteriaTest() {
        ...
        }
        {
            ...
            UserCriteria criteria = new UserCriteria();
            criteria.setLoginId(eq("user050"));
        ...
        }
        {
            ...
            UserCriteria criteria = new UserCriteria();
            criteria.setLoginId(eq("user050"));
            criteria.getLoginId().setNot(true);
        ...
        }
        {
            ...
            UserCriteria criteria = new UserCriteria();
            criteria.setLoginId(like("user05%"));
